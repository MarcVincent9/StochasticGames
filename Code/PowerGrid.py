...
class PowerGrid(NullSum2PlayerStochasticGame):
    """
    Example of a null sum 2-player stochastic game: attack-defense of power network (cf. Ma, Yau, Lou, Rao 2013)
    """
    
    def __init__(self, graph, p_pf, p_upf, p_pr, p_upr, budget):
        self.graph = graph
        self.p_pf = p_pf
        self.p_upf = p_upf
        self.p_pr = p_pr
        ...
        # the list of actions is limited to dominant actions, those that use all the budget
